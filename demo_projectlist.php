		...
		<div class="card-body">
			...
			<table class="table tabe-hover table-condensed" id="list">
				...
				<tbody>
                    ...
                    $qry = $conn->query("SELECT project_list.*, GROUP_CONCAT(users.name) AS team_lead_names
                                         FROM project_list
                                         INNER JOIN users ON users.id = project_list.manager_id
                                         {$where}
                                         GROUP BY project_list.id
                                         ORDER BY project_list.name ASC");
...
print_r($qry);die;
					...
					<tr>
						...
						<td>
							<p><a class="dropdown-item view_project" href="./index.php?page=view_project&id=<?php echo $row['id'] ?>" data-id="<?php echo $row['id'] ?>"><b><?php echo ucwords($row['name']) ?></b></a></p>
