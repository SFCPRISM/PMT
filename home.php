...
<!-- Info boxes -->
 <div class="col-12">
          <div class="card">
            <div class="card-body">
              Welcome <?php  print_r($_SESSION['login_name'])?>!
  ...
  <?php 
    ...
    if($_SESSION['login_type'] == 2){
     ...
     $where2 = "";
    if($_SESSION['login_type'] == 2){
      $where2 = " where concat('[',REPLACE(p.manager_id,',','],['),']') LIKE '%[{$_SESSION['login_id']}]%' ";
    }elseif($_SESSION['login_type'] == 4){
      $where2 = " where concat('[',REPLACE(p.tech_lead_id,',','],['),']') LIKE '%[{$_SESSION['login_id']}]%' ";
    }elseif($_SESSION['login_type'] == 6){
      $where2 = " where p.guest_id = '{$_SESSION['login_id']}' ";
    }elseif($_SESSION['login_type'] == 7){
      $where2 = " where concat('[',REPLACE(p.team_lead,',','],['),']') LIKE '%[{$_SESSION['login_id']}]%' ";
    }elseif($_SESSION['login_type'] == 3 || $_SESSION['login_type'] == 8){
      $where2 = " where concat('[',REPLACE(t.user_id,',','],['),']') LIKE '%[{$_SESSION['login_id']}]%'  ";
    }elseif( $_SESSION['login_type'] == 5){
      $where2 = " where concat('[',REPLACE(t.tester_id,',','],['),']') LIKE '%[{$_SESSION['login_id']}]%'  ";
    }
    ?>
            ...
            <div class="table-responsive">
              <table class="table m-0 table-hover">
                ...
                if($_SESSION['login_type'] == 2){
                 ...
                 // $where = " where tech_lead_id = '{$_SESSION['login_id']}' ";
                  $where = " where concat('[',REPLACE(tech_lead_id,',','],['),']') LIKE '%[{$_SESSION['login_id']}]%' ";

                }elseif( $_SESSION['login_type'] == 7){
                 // $where = " where team_lead = '{$_SESSION['login_id']}' ";
        ...
        <div class="col-md-4">
          ...
          <div class="col-12 col-sm-6 col-md-12">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner totaltask"><a href="./index.php?page=project_list">
                <h3><?php echo $conn->query("SELECT * FROM project_list $where")->num_rows; ?></h3>

                <p>Total Projects</p></a>
              </div>
              <div class="icon">
           ...
           <div class="col-12 col-sm-6 col-md-12">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner totaltask"><a href="./index.php?page=task_list">
