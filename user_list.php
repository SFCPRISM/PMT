		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					<?php
					$i = 1;
					$type = array('',"Admin","Project Manager","Developer","Tech Lead","Tester","Guest","Team Lead","Marketing Associate");
					...
					<tr>
						...
						<td><a class="dropdown-item view_user" href="javascript:void(0)"
								data-id="<?php echo $row['id'] ?>"><b>
...
<script>
	$(document).ready(function () {
		...
		$('#list').on('click', '.view_user', function () {
