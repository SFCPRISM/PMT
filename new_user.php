					...
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								...
								<option value="8" <?php echo isset($type) && $type == 8 ? 'selected' : '' ?>>Marketing Associate</option>
								<option value="5" <?php echo isset($type) && $type == 5 ? 'selected' : '' ?>>Tester</option>
								<option value="6" <?php echo isset($type) && $type == 6 ? 'selected' : '' ?>>Guest</option>
								<option value="7" <?php echo isset($type) && $type == 7 ? 'selected' : '' ?>>Team Lead</option>
								<option value="4" <?php echo isset($type) && $type == 4 ? 'selected' : '' ?>>Tech Lead</option>
						...
						<div class="form-group displaynone">
							...
							<select class="form-control form-control-sm select2" multiple="multiple" name="teams[]">
              					<option></option>
              					<?php 
              					...
              					?>
              					<option value="<?php echo $row['id'] ?>" <?php echo isset($teams) && in_array($row['id'],explode(',',$teams)) ? "selected" : '' ?>><?php echo ucwords($row['name']) ?></option>
              					<?php endwhile; ?>
              				</select>
						</div>
						<div class="form-group">
							...
							<div class="custom-file">
		                      <input type="file" accept="image/jpeg,image/jpg, image/png" class="custom-file-input" id="customFile" name="img" onchange="displayImg(this,$(this))">
...
<script>
	$(document).ready(function() {
		...
		if(value == 7){
			const targetDivs = document.getElementsByClassName('displaynone');
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					alert_toast('Email Allready Exits.',"warning");
					setTimeout(function(){	
